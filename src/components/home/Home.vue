...
.icn-arrow{
  -webkit-animation: anim02 5s 1s ease 1;
          animation: anim02 5s 1s ease 1;
  -webkit-animation: anim03 1.5s 1s ease infinite;
          animation: anim03 1.5s 1s ease infinite;
  -webkit-animation-fill-mode: forwards;
          animation-fill-mode: forwards;
}
...
.icn-circle circle:first-child{
  -webkit-animation: anim04 2s .5s linear infinite;
          animation: anim04 2s .5s linear infinite;
  -webkit-animation-fill-mode: forwards;
          animation-fill-mode: forwards;
}

.icn-circle circle:nth-child(2){
  -webkit-animation: anim04 3s .5s linear infinite;
          animation: anim04 3s .5s linear infinite;
  -webkit-animation-fill-mode: forwards;
          animation-fill-mode: forwards;
}

.icn-circle circle:nth-child(3){
  -webkit-animation: anim04 4s .5s linear infinite;
          animation: anim04 4s .5s linear infinite;
  -webkit-animation-fill-mode: forwards;
          animation-fill-mode: forwards;
}
